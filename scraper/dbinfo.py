...
JCDECAUX_SCRAPE_INTERVAL = int(os.getenv("JCDECAUX_SCRAPE_INTERVAL", "300"))  # 5 min
OPENWEATHER_SCRAPE_INTERVAL = int(os.getenv("OPENWEATHER_SCRAPE_INTERVAL", "600"))  # 10 min
MAIN_LOOP_SLEEP = int(os.getenv("MAIN_LOOP_SLEEP", "30")) # Sleep time between checks in the main loop